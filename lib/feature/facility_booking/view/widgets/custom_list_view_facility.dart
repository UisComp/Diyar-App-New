      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return GestureDetector(
            // Only a closed facility needs this — a disabled checkbox swallows
            // no taps of its own, and the controller answers with the reason.
            onTap: bookable ? null : () => controller.toggleItem(item.id!),
