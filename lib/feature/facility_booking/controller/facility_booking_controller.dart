...
class FacilityBookingController extends Cubit<FacilityBookingState> {
  ...
  Future<void> getAllFacilityBooking() async {
    ...
    await FacilityBookingService.getAllFacilityBooking()
        .then((value) {
        ...
        .catchError((error) {
          emit(FacilityBookingFailureState(errorMessage: error.toString()));
          AppLogger.error("Error in getAllFacilityBooking: $error");
        });
  }
}
